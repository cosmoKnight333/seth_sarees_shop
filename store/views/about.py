...
def show_about(request):
    ...
    data['meta_tags']='Banarasi sarees,silk sarees, Varanasi, finest quality, luxurious, unique, traditional, hand-woven silk, modern printed styles, wholesaler, retailer, showroom, knowledgeable staff, excellent customer service, social media, email list, special discounts, promotions'
